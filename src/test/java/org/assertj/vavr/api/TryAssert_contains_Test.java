...
public class TryAssert_contains_Test extends BaseTest {
    ...
    @Test
    public void should_pass_when_success_try_contains_equal_value() throws Exception {
    ...
    @Test
    public void should_pass_when_success_try_contains_same_value() throws Exception {
