...
class ValidationAssert_containsInvalid_usingFieldByFieldValueComparator_Test {
	...
	void should_fail_when_validation_is_null() {
		assertThrows(AssertionError.class, () -> assertThat((Validation<String, Foo>) null)
				.usingFieldByFieldValueComparator().containsInvalid("something"), actualIsNull());
	}

	@Test
	void should_fail_if_expected_value_is_null() {
		assertThrows(
				IllegalArgumentException.class, () -> assertThat(Validation.invalid(new Foo("something")))
